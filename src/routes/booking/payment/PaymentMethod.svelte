		...
		<div class="full-payment-wrapper">
				...
				<section class="section-block">
					<div class="paylabs-info">
						...
						<p class="paylabs-desc">
							On-Journey uses Paylabs to process your credit and debit card transactions, ensuring a
			...
			{#if fullMethod === 'ewallet'}
				<section class="section-block">
					...
					<div class="bank-grid">
						{#each ewallets as wallet (wallet.id)}
							<button
								class="bank-card"
		...
		<div class="split-wrapper">
			...
			{#each splits as split, index (split.id)}
				<div class="split-block">
					...
					<p class="sub-label">Payment Method</p>
					<div class="method-row">
						{#each [{ id: 'bank_transfer', label: 'Bank Transfer' }, { id: 'credit_card', label: 'Credit/Debit Card' }, { id: 'ewallet', label: 'E-Wallet' }] as m (`${split.id}-${m.id}`)}
							<button
								class="method-card"
					...
					{#if split.method === 'credit_card'}
						<div class="paylabs-info">
							<img src="/src/lib/assets/Bank/PayLabs.png" alt="Paylabs" class="paylabs-logo" />
							<p class="paylabs-desc">
								On-Journey uses Paylabs to process your credit and debit card transactions, ensuring
								a secure and reliable payment experience.
							</p>
						</div>
					{/if}
				</div>
			...
			{#if splits.length >= MAX_SPLITS}
				<div class="max-warning">
					...
					<span
						>You can only split this payment into a <strong>maximum of {MAX_SPLITS} parts</strong>.
						Please adjust your selection.</span
					>
				</div>
			{/if}
