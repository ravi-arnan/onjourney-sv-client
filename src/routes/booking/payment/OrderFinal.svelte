...
<div class="order-card">
	...
	<p class="additional-note">
		Additional fees from payment method may applied after proceed the payment.
	</p>
	...
	<p class="terms-note">
		...
		<a href={resolve('/terms' as any)} class="terms-link">On Journey's Terms & Conditions</a> &
		<!-- eslint-disable-next-line @typescript-eslint/no-explicit-any -->
		<a href={resolve('/privacy' as any)} class="terms-link">Privacy Policy</a>
	</p>
</div>
