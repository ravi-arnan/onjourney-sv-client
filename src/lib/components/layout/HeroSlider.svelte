...
<div class="slider">
	{#each slides as slide, i (i)}
		<a
			href={resolve(slide.link as any)}
			class="slide
      {i === current ? 'active' : ''}
      {i ===
			(direction === 'next'
	...
	<!-- Arrow -->
	<button class="arrow left" on:click={prev} aria-label="Previous slide"> ‹ </button>

	<button class="arrow right" on:click={next} aria-label="Next slide"> › </button>
